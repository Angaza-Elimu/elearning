...
console.log(subject_name);
  if(paths.length ===1) {
    const name = topic_name[0].toUpperCase() + topic_name.substring(1).replace(/%3A/g, ": ").replace(/_/g, " ")
    const subject = subject_name[0].toUpperCase() + subject_name.substring(1).replace(/%3A/g, ": ").replace(/_/g, " ")
    return (
