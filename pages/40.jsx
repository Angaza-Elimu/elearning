    ...
    <Layout>
      ...
      <div className="p-6 py-8 rounded-lg bg-shade-light w-full flex flex-col items-center gap-10 flex-1 mb-10">
        ...
        <div className="text-lg mx-auto space-y-4 w-full flex flex-col items-center flex-1">
          <Button name="Continue to next subtopic" onClick={() => router.push(`/learn/topics/${topic_id}`)} />

          <p>
            Want to try again?{" "}
            <span className="text-xl font-semi cursor-pointer text-primary-700 hover:underline" onClick={() => router.push(`/learn/quiz/${subtopic_id}`)}>
              Retake quiz
            </span>
          </p>
        </div>
